...
@WebMvcTest(JwtJobPortalController.class)
public class TestJobPrortalControllerPutEndPoint {
	...
	public void setUp() {
		...
		try {
			mvc.perform(post(JWT_CONTEXT_PATH + "/add").accept(MediaType.APPLICATION_JSON)
	...
	public void test_put_end_point_with_json_data() throws Exception {
		...
		mvc.perform(put(JWT_CONTEXT_PATH + "/update").accept(MediaType.APPLICATION_JSON)
		...
		mvc.perform(get(JWT_CONTEXT_PATH + "/find").queryParam("id", String.valueOf(id)).queryParam("jobTitle",
	...
	public void test_put_end_point_with_xml_data() throws Exception {
		...
		mvc.perform(put(JWT_CONTEXT_PATH + "/update").accept(MediaType.APPLICATION_XML).contentType(MediaType.APPLICATION_XML)
		...
		mvc.perform(get(JWT_CONTEXT_PATH + "/find").queryParam("id", String.valueOf(id)).queryParam("jobTitle", JOB_TITLE + "Update xml"))
